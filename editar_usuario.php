...
<body>
    ...
    <div class="container my-5">
        ...
        <!--Formulário-->
        <div class="my-5">
            <form method="POST" action="edi_usuario.php">
                <div class="col-3" >
                    <!--campo para saber o que está sendo editado-->
                    <input type="hidden" name="id" value="<?php echo $row_usuario['id']; ?>">
                    <label class="form-label fw-bold">Informe seu nome completo</label>
                    <input type="text" class="form-control" name="nome" placeholder="Nome:" value="<?php echo $row_usuario['nome']; ?>">
                </div>
                <div class="col-3 my-4">
                    <label class="form-label fw-bold">Informe seu E-mail</label>
                    <input type="text" class="form-control" name="email" placeholder="Email:" value="<?php echo $row_usuario['email']; ?>">
                </div>
                <div class="col-3">
                    <label class="form-label fw-bold">Informe seu Telefone</label>
                    <input type="text" class="form-control" name="telefone" placeholder="11 1234-5678" value="<?php echo $row_usuario['email']; ?>">
                </div>
