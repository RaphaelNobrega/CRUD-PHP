            ...
            <tbody>
                ...
                <?php while($row_usuarios = mysqli_fetch_assoc($resultado_usuarios)){ ?>  
                    <tr>
                        ...
                        <td><?= $row_usuarios['nome']; ?></td>
                        <td><?= $row_usuarios['email']; ?></td>
                        <td><?= $row_usuarios['telefone']; ?></td>
                        <td>
                            <button type='button' class='btn btn-primary'>
                                <a class='link-light text-decoration-none' href='editar_usuario.php?id=<?= $row_usuarios['id'] ?>'>Editar</a>
                            </button>  
                        </td>
                        <td>
                            <button type='button' class='btn btn-danger'>
                                <a class='link-light text-decoration-none' href='del_usuario.php?id=<?= $row_usuarios['id'] ?>'>Apagar</a>
                            </button>  
                        </td>
                    </tr>
                <?php } ?>
